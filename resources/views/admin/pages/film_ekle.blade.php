            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Yeni Film</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body table-responsive">
                        <form action="{{ route('admin.filmler.store')  }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="adi" class="form-control" id="fAdi">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="fYonetmen">Yönetmen</label>
                                        <input type="text" name="yonetmen"class="form-control" id="fYonetmen">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="fOyuncular">Oyuncular</label>
                                        <input type="text" name="oyuncular"class="form-control" id="fOyuncular">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="cBilet">Bilet Ücreti</label>
                                        <input type="text" name="bilet_ucreti" id="cBilet" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="fSure">Süresi</label>
                                        <input type="text" name="sure"class="form-control" id="fSure" placeholder="150 dakika">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="fVizyonTarihi">Vizyon Tarihi</label>
                                        <input type="text" name="vizyon_tarihi" class="form-control" id="fVizyonTarihi" placeholder="Y-m-d">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="fFragman">Fragman Adresi</label>
                                        <input type="text" name="fragman_url"class="form-control" id="fFragman" placeholder="">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <select name="format_id" class="form-control form-control-border" id="cFormat">
                                            ...
                                            @if(!$formatlar->isEmpty())
                                                @foreach($formatlar as $format)
                                                    <option value="{{ $format->id  }}">{{ $format->adi }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="dil_id" class="form-control form-control-border" id="cDil">
                                            ...
                                            @if(!$diller->isEmpty())
                                                ...
                                                <option value="{{ $dil->id  }}">{{ $dil->adi }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <select name="salon_id" class="form-control form-control-border" id="cSalon">
                                            ...
                                            @if(!$salonlar->isEmpty())
                                                @foreach($salonlar as $salon)
                                                    <option style="display: none;" data-avmid="{{ $salon->avm_id  }}" value="{{ $salon->id  }}">{{ $salon->adi }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="seans_id[]" class="form-control form-control-border select2" id="cSeanslar"  multiple="multiple">
                                            ...
                                            @if(!$seanslar->isEmpty())
                                                ...
                                                <option value="{{ $seans->id  }}">{{ $seans->adi }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="aciklama" id="summernote">
                                            Lütfen film açıklamasını <strong>buraya giriniz</strong>
                                          </textarea>
                                    </div>
                                </div>
                                <!-- /.col-->
